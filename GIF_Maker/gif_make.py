...
def capture_gif():
    """設定に基づいてウィンドウの上部4cmを除いた部分のスクリーンショットを撮影し、GIFとして保存する"""
...
frame_delay_entry.insert(0, "0.2")
...
capture_button.grid(row=4, column=0, columnspan=2, pady=10)
